...
export const translations: Translations = {
    ...
    // Package Detail
    detail_back: { id: 'Kembali', en: 'Back' },
    detail_share_copied: { id: 'Link disalin!', en: 'Link copied!' },
    detail_quota_remaining: { id: 'Sisa', en: 'Left' },
    detail_quota_unit: { id: 'Pax', en: 'Pax' },
    detail_tab_itinerary: { id: 'Itinerary', en: 'Itinerary' },
    detail_tab_facilities: { id: 'Fasilitas', en: 'Facilities' },
    detail_tab_terms: { id: 'Syarat & Ketentuan', en: 'Terms & Conditions' },
    detail_itinerary_empty: { id: 'Itinerary belum tersedia.', en: 'Itinerary not yet available.' },
    detail_flights_title: { id: 'Maskapai Penerbangan', en: 'Airlines' },
    detail_airline_tba: { id: 'Airline TBA', en: 'Airline TBA' },
    detail_hotels_title: { id: 'Akomodasi Hotel', en: 'Hotel Accommodation' },
    detail_hotel_empty: { id: 'Data hotel belum tersedia.', en: 'Hotel information not yet available.' },
    detail_included: { id: 'Harga Termasuk', en: "What's Included" },
    detail_not_included: { id: 'Tidak Termasuk', en: 'Not Included' },
    detail_no_data: { id: 'Belum ada data.', en: 'No data available.' },
    detail_room_title: { id: 'Pilih Tipe Kamar', en: 'Select Room Type' },
    detail_room_prefix: { id: 'Kamar', en: 'Room' },
    detail_room_people: { id: 'Orang', en: 'People' },
    detail_room_empty: { id: 'Tipe kamar belum dikonfigurasi.', en: 'Room types not yet configured.' },
    detail_price_label: { id: 'Total Harga per Orang', en: 'Total Price per Person' },
    detail_seats_filled: { id: 'Kursi Terisi', en: 'Seats Filled' },
    detail_includes_note: { id: 'Termasuk tiket pesawat & hotel', en: 'Includes airfare & hotel' },
    detail_book_wa: { id: 'Booking via WhatsApp', en: 'Book via WhatsApp' },
    detail_brochure: { id: 'Brosur Lengkap (PDF)', en: 'Full Brochure (PDF)' },
    detail_price_note: { id: '*Harga sewaktu-waktu dapat berubah mengikuti kebijakan maskapai & hotel.', en: '*Prices are subject to change based on airline & hotel policies.' },
    detail_help_title: { id: 'Butuh Bantuan?', en: 'Need Help?' },
    detail_help_desc: { id: 'Tim konsultan kami siap membantu Anda 24/7 untuk perencanaan ibadah.', en: 'Our consultants are ready to help you 24/7 for worship planning.' },
    detail_help_cta: { id: 'Hubungi Konsultan', en: 'Contact Consultant' },
    detail_help_wa_message: { id: 'Assalamualaikum Alfatih Dunia Wisata, saya membutuhkan bantuan informasi mengenai paket tour. Mohon bantuannya, terima kasih.', en: 'Hello Alfatih Dunia Wisata, I need assistance with information about your tour packages. Thank you.' },
    detail_book_wa_message: { id: 'Assalamualaikum Alfatih Dunia Wisata, saya tertarik dengan paket', en: 'Hello Alfatih Dunia Wisata, I am interested in the package' },
    detail_book_wa_departure: { id: 'untuk keberangkatan', en: 'departing on' },
    detail_book_wa_room: { id: 'Tipe kamar', en: 'Room type' },
    detail_book_wa_suffix: { id: 'Mohon info detailnya.', en: 'Please share more details.' },
};
